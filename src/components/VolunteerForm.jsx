...
function VolunteerForm() {
    ...
    const sendConfirmationEmail = (email, eventName) => {
        alert(
            `Подтверждение отправлено на ${email} для мероприятия "${eventName}".`
        );
    };
    ...
    return (
        <div className="backforms">
            <form onSubmit={handleSubmit}>
                <div className="mb-3">
                    <label htmlFor="volunteer-name" className="form-label">
                        Ваше имя
                    </label>
                    <input
                        type="text"
                ...
                <div className="mb-3">
                    <label htmlFor="volunteer-email" className="form-label">
                        Ваш Email
                    </label>
                    <input
                        type="email"
